...
//	while문을 통해서 무한 반복하면서 필드 gas의 값을 화면에 출력하고 gas의 값을 감소 시킴
	void run() {
//		while 문의 조건식 자체가 true이므로 결과도 true가 되어 무한 반복으로 동작함
		while (true) {
//			필드 gas의 현재값이 0 보다 큰지 작은지 확인
			if (gas > 0) {
//				gas가 0보다 클 경우 gas의 현재값 출력 후 gas의 값 1감소
...
//				메소드가 종료되면 현재 메소드 내부에서 동작하는 whiel문도 자동으로 종료됨
				return;
			}
		}
	}
