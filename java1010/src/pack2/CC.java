...
public class CC {
	public void execute(){
//		pack1 패키지의 AA클래스 사용, 생성자 사용
//		생성자의 접근제한자 public, 다른 패키지에서 사용 시 제한 없음
		AA a1 = new AA();
...
//		필드의 접근제한자가 default, 다른 패키지엣 사용 불가
//		System.out.println(a1.defaultField);
//		필드이 접ㄱ느제한장가 프라이빗, 외부에서 사용 불가
// 		System.out.println(a1.privateField);

//		메소드 사용
//		메소드의 접근제한자가 public, 다른 패키지에서 사용가능
		a1.publicMethod();
//		메소드의 접근제한자가 default, 다른 패키지에서 사용 불가
//		a1.defaultMethod();
//		메소듸 접근제한자가 private,  외부에서 사용 불가
//		a1.privateMethod();

//		메소딍 접근제한자가public, public인 멤버를 통해서 일반적으로 접근이 불가능한 필드, 메소드를 우회해서 사용함
		a1.print();
