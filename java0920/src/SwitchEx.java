...
//        - 위에서 부터 아래로 case문을 하나씩  비교
//        - 순차적으로 비교값을 설정해야 함
//        - 각각의 case문 끝에 있는 break문을 생략하면 안됨
//        - break 생략시 break를 만날때 까지 아래에 있는 case문을 실행함
//        - 모든 case문과 일치 하지 않을 경우 default문이 실행됨
...
//        break;
//        case 조건값2:
//          비교값이 조건값2과 동일할 경우 실행할 소스코드...
//        break;
//        case 조건값n:
//          비교값이 조건값n과 동일할 경우 실행할 소스코드...
//        break;
//        default:
//          비교값이 조건값과 일치하지 않을 경우 실행할 소스코드...
//        break;
//        }
...
//        LocalDate : 자바 8버전 이후로 제공되는 날ㅃ짜 관련 클래스
...
//        if문은 조건식의 범위를 기준으로 결과값을 true 인지 false인지 판단함
//        if문은 범용적으로 사용하기에 좋음
//        switch~ case 문은 값을 기준으로 case문의 값과 동일한지 판단함
//        switch~ case 문은 고정된 값을 비교 시 사용하기 좋음
