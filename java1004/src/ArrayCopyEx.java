...
//        얕은 복사 : 배열 A를 배열 B에 단순 대입, 배열A의 주소를 배열 B에 복사함
//        - 배열A와 배열B가 같은 주소를 공유하고 있기 때문에 한쪽에서 데이터 변경 시 다른 배열의 데이터도 함께 변경됨

//        깊은 복사 : 배열 A의 내용을 모두 배열 B로 복사, 배열 A의 주소와 배열 B의 주소가 서로 다르기 때문에 한쪽에서 데이터 변경 시에도 다른 쪽에서의 데이터 변경이 없음

        System.out.println("----- 얕은 복사 -----"); // 같은 주소를 공유,복사
        ...
        System.out.println("원본 배열 B : " + iArr2);

//        배열 iArr1의 값을 배열 iArr2에 단순대입
        iArr2 = iArr1;
        System.out.println("\n iArr2에 iArr1 을 복사 후\n");
...
//        사용법 :
//        System.arraycopy(원본배열, 원본 배열 시작index, 타켓배열, 타겟 배열 시작index, 복사할 배열 크기);
        int[] iArr5 = {10, 20, 30};
...
//        배열 iArr7 번의 index 1 ~index 3 (index 3은 미포함)까지의 배열을 새로은 배열로 만들어서 배열 변수 iArr8에 저장
